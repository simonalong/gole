...
func TestMd5(t *testing.T) {
	...
	f := "/Users/rarnu/Code/simonalong/opensource/gole/go.mod"
...
func TestRSA(t *testing.T) {
	privKeyPath := "/Users/rarnu/Code/simonalong/opensource/gole/test/rsa/private.pem"
	pubKeyPath := "/Users/rarnu/Code/simonalong/opensource/gole/test/rsa/public.pem"
...
func TestDSA(t *testing.T) {
	privKeyPath := "/Users/rarnu/Code/simonalong/opensource/gole/test/dsa/private.pem"
	pubKeyPath := "/Users/rarnu/Code/simonalong/opensource/gole/test/dsa/public.pem"
	if !file.FileExists(privKeyPath) {
